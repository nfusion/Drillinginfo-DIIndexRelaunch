...
class acf_form_widget
{
    ...
    */
    ...
    public function edit_widget($widget, $return, $instance)
    {
    ...
    */
    ...
    public function customizer_widget_update_callback($instance, $new_instance, $old_instance, $widget)
    {
    ...
    */
    ...
    public function get_customizer_widgets($customizer)
    {
