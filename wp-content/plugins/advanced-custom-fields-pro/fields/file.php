...
<div <?php acf_esc_attr_e($div);
	...
	<div class="show-if-value file-wrap acf-soh">
		<div class="file-icon">
			<img data-name="icon" src="<?php echo $o['icon'];
        ?>" alt=""/>
		</div>
		<div class="file-info">
			<p>
				<strong data-name="title"><?php echo $o['title'];
        ?></strong>
			</p>
			<p>
				<strong><?php _e('File name', 'acf');
        ?>:</strong>
				<a data-name="name" href="<?php echo $o['url'];
        ?>" target="_blank"><?php echo $o['name'];
        ?></a>
			</p>
			<p>
				<strong><?php _e('File size', 'acf');
        ?>:</strong>
				<span data-name="size"><?php echo $o['size'];
        ?></span>
			</p>
	...
	<div class="hide-if-value">
		<?php if ($uploader == 'basic'): ?>
			...
			<?php if ($field['value'] && !is_numeric($field['value'])): ?>
				<div class="acf-error-message"><p><?php echo $field['value'];
        ?></p></div>
			<?php endif;
        ?>
        ...
        ?> <a data-name="add" class="acf-button button" href="#"><?php _e('Add File', 'acf');
        ?></a></p>
...
<?php
    ...
    */
    ...
    public function get_media_item_args($vars)
    {
        $vars['send'] = true;
