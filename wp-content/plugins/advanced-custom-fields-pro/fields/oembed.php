...
class acf_field_oembed extends acf_field
{
    ...
    */
    ...
    public function wp_oembed_get($url = '', $width = 0, $height = 0)
    {
...
<div <?php acf_esc_attr_e($atts) ?>>
	<div class="acf-hidden">
		<input type="hidden" data-name="value-input" name="<?php echo esc_attr($field['name']);
	...
	<div class="title acf-soh">
		...
		<div class="title-value">
			<h4 data-name="value-title"><?php echo $field['value'];
        ?></h4>
		</div>
		
		<div class="title-search">
			
			<input data-name="search-input" type="text" placeholder="<?php _e('Enter URL', 'acf');
        ?>" autocomplete="off" />
		</div>
	...
	<div class="canvas">
		...
		<div class="canvas-error">
			<p><strong><?php _e('Error', 'acf');
        ?></strong>. <?php _e('No embed found for the given URL', 'acf');
        ?></p>
		</div>
