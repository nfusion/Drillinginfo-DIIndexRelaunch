...
class acf_field_taxonomy extends acf_field
{
    ...
    */
    ...
    public function set_terms($post_id)
    {
...
<div <?php acf_esc_attr_e($div);
	...
	<a href="#" class="acf-icon -plus acf-js-tooltip small acf-soh-target" data-name="add" title="<?php echo esc_attr($taxonomy->labels->add_new_item);
        ?>"></a>
	<?php endif;
    ...
    */
    ...
    public function ajax_add_term()
    {
        ...
        ?><p class="acf-submit"><button class="acf-button button button-primary" type="submit"><?php _e('Add', 'acf');
