...
<div <?php acf_esc_attr_e(array('class' => 'acf-flexible-content', 'data-min' => $field['min'], 'data-max'    => $field['max']));
	...
	<div class="no-value-message" <?php if ($field['value']) {
	...
	<ul class="acf-actions acf-hl">
		<li>
			<a class="acf-button button button-primary" data-event="add-layout"><?php echo $field['button_label'];
        ?></a>
		</li>
	</ul>
	...
	<script type="text-html" class="tmpl-popup"><?php 
        ...
        ?>
					<li>
						<a href="#" <?php acf_esc_attr_e($atts);
...
<div <?php acf_esc_attr_e($div);
	...
	<div class="acf-fc-layout-handle"><?php echo $title;
        ?></div>
	
	<ul class="acf-fc-layout-controlls acf-hl">
		<li class="acf-fc-show-on-hover">
			<a class="acf-icon -plus small" href="#" data-event="add-layout" title="<?php _e('Add layout', 'acf');
        ?>"></a>
		</li>
		<li class="acf-fc-show-on-hover">
			<a class="acf-icon -minus small" href="#" data-event="remove-layout" title="<?php _e('Remove layout', 'acf');
        ?>"></a>
		</li>
		<li>
			<a class="acf-icon -collapse small" href="#" data-event="collapse-layout" title="<?php _e('Click to toggle', 'acf');
        ?>"></a>
		</li>
	</ul>
	...
	<table class="acf-table">
        ...
        ?>
						<?php if ($sub_field['instructions']): ?>
							<p class="description"><?php echo $sub_field['instructions'];
        ?></p>
						<?php endif;
        ?>
					</th>
    ...
    */
    ...
    public function render_field_settings($field)
    {
        ...
        foreach ($field['layouts'] as $layout) {
            ...
            ?>">
	<td class="acf-label">
		<label><?php _e('Layout', 'acf');
            ?></label>
		<p class="description acf-fl-actions">
			<a data-name="acf-fc-reorder" title="<?php _e('Reorder Layout', 'acf');
            ?>" ><?php _e('Reorder', 'acf');
            ?></a>
			<a data-name="acf-fc-delete" title="<?php _e('Delete Layout', 'acf');
            ?>" href="#"><?php _e('Delete', 'acf');
            ?></a>
			<a data-name="acf-fc-duplicate" title="<?php _e('Duplicate Layout', 'acf');
            ?>" href="#"><?php _e('Duplicate', 'acf');
            ?></a>
			<a data-name="acf-fc-add" title="<?php _e('Add New Layout', 'acf');
            ?>" href="#"><?php _e('Add New', 'acf');
            ?></a>
		</p>
	</td>
	<td class="acf-input">
		...
		<ul class="acf-fc-meta acf-bl">
			...
			<li class="acf-fc-meta-display">
				<div class="acf-input-prepend"><?php _e('Layout', 'acf');
            ?></div>
