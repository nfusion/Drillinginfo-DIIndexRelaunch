...
class acf_field_gallery extends acf_field
{
    ...
    */
    ...
    public function render_attachment($id, $field)
    {
        ...
        ?>" />
			<p class="filename"><strong><?php echo $attachment['filename'];
        ?></strong></p>
			<p class="uploaded"><?php echo $attachment['dateFormatted'];
        ?></p>
			<p class="dimensions"><?php echo $dimentions;
        ?></p>
			<p class="actions"><a href="#" class="edit-attachment" data-id="<?php echo $id;
        ?>"><?php _e('Edit', 'acf');
        ?></a> <a href="#" class="remove-attachment" data-id="<?php echo $id;
        ?>"><?php _e('Remove', 'acf');
        ?></a></p>
		</div>
...
<div <?php acf_esc_attr_e($atts);
	...
	<div class="acf-gallery-main">
        ...
        ?>"/>
							...
							<?php if ($type !== 'image'): ?>
							<div class="filename"><?php echo acf_get_truncated($filename, 18);
        ?></div>
							<?php endif;
        ?>
						</div>
						<div class="actions acf-soh-target">
							<a class="acf-icon -cancel dark remove-attachment" data-id="<?php echo $post->ID;
        ?>" href="#"></a>
						</div>
					</div>
		...
		<div class="acf-gallery-toolbar">
			...
			<ul class="acf-hl">
				<li>
					<a href="#" class="acf-button button button-primary add-attachment"><?php _e('Add to gallery', 'acf');
        ?></a>
				</li>
				<li class="acf-fr">
					<select class="bulk-actions">
						<option value=""><?php _e('Bulk actions', 'acf');
        ?></option>
						<option value="date"><?php _e('Sort by date uploaded', 'acf');
        ?></option>
						<option value="modified"><?php _e('Sort by date modified', 'acf');
        ?></option>
						<option value="title"><?php _e('Sort by title', 'acf');
        ?></option>
						<option value="reverse"><?php _e('Reverse current order', 'acf');
        ?></option>
					</select>
				</li>
			</ul>
	...
	<div class="acf-gallery-side-inner">
		...
		<div class="acf-gallery-toolbar">
			...
			<ul class="acf-hl">
				<li>
					<a href="#" class="acf-button button close-sidebar"><?php _e('Close', 'acf');
        ?></a>
				</li>
				<li class="acf-fr">
					<a class="acf-button button button-primary update-attachment"><?php _e('Update', 'acf');
        ?></a>
				</li>
			</ul>
